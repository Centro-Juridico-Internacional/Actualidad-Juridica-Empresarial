...
const FlipBookInternal = React.memo(
	({
		...
		// Memoizar opciones de PDF.js para evitar re-renders y "Transport destroyed"
...
const Revista: React.FC<RevistaProps> = ({ pdfUrl, className = '', width = 600, height = 800 }) => {
	...
	return (
		<div className={`revista-container ${className}`}>
			...
			{/* Componente FlipBook Aislado - Responsive wrapper */}
			<div className="flex w-full justify-center">
				<div className="w-full max-w-[95vw] sm:max-w-[600px] md:max-w-[800px] lg:max-w-[1000px] xl:max-w-[1200px]">
					<FlipBookInternal
						pdfUrl={pdfUrl}
						width={width}
						height={height}
